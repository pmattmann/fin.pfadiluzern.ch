...
return [
    'fin' => [
        'from_mail' => getenv('from_mail'),
        'from_name' => getenv('from_name'),
        'from_password' => getenv('from_password'),
        'to_mail' => getenv('to_mail'),
        ...
        'konten' => [
            '4100'      => '4100 Vertretung PBS (DV, BuKo, Präsi)',
            '4110.01'   => '4110 Kantonale DV',
            '4110.02'   => '4110 Kantonale DV - Abschiedsgeschenke',

            '4120'      => '4120 Vorstand',
            '4120.01'   => '4120 Vorstand - Ehemaligentreffen',
            '4120.02'   => '4120 Vorstand - Visionentreffen',
